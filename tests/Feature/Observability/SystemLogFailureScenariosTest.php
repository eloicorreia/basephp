...
final class SystemLogFailureScenariosTest extends TestCase
{
    ...
    {
        $this->markTestIncomplete('Adicionar rota e cenário controlado para falha antes da resolução do tenant.');
    }

    public function test_it_persists_system_log_when_authorization_fails(): void
    {
        $this->markTestIncomplete('Cobrir negação de acesso e system log correspondente.');
    }
    ...
    {
        $this->markTestIncomplete('Adicionar assert explícito para sanitização do system log.');
    }
}
