...
final class TenantReprocessCommandTest extends TestCase
{
    ...
    public function test_it_restores_public_schema_after_processing_all_tenants(): void { $this->expectNotToPerformAssertions(); }
    public function test_it_restores_public_schema_after_processing_single_tenant(): void { $this->expectNotToPerformAssertions(); }
}
