...
final class WebhookSettingsController extends BaseTenantSettingController
{
    ...
    {
        return 'admin.system-settings.webhooks';
    }

    protected function routeName(): string
    {
        return 'admin.system-settings.webhooks.edit';
    }

    public function update(UpdateTenantWebhookSettingsRequest $request): RedirectResponse
    {
