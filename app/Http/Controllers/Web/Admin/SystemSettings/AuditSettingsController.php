...
final class AuditSettingsController extends BaseTenantSettingController
{
    ...
    protected function viewName(): string { return 'admin.system-settings.audit'; }

    protected function routeName(): string { return 'admin.system-settings.audit.edit'; }

    public function update(UpdateTenantAuditSettingsRequest $request): RedirectResponse { return $this->updateSetting($request); }
}
