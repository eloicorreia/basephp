...
final class QueueSettingsController extends BaseTenantSettingController
{
    ...
    {
        return 'admin.system-settings.queues';
    }

    protected function routeName(): string
    {
        return 'admin.system-settings.queues.edit';
    }

    public function update(UpdateTenantQueueSettingsRequest $request): RedirectResponse
    {
