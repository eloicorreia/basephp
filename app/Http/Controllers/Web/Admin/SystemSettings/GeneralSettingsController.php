...
final class GeneralSettingsController extends BaseTenantSettingController
{
    ...
    {
        return 'admin.system-settings.general';
    }

    protected function routeName(): string
    {
        return 'admin.system-settings.general.edit';
    }

    public function update(UpdateTenantSystemSettingsRequest $request): RedirectResponse
    {
