...
final class ApiSettingsController extends BaseTenantSettingController
{
    ...
    protected function viewName(): string { return 'admin.system-settings.api'; }

    protected function routeName(): string { return 'admin.system-settings.api.edit'; }

    public function update(UpdateTenantApiSettingsRequest $request): RedirectResponse { return $this->updateSetting($request); }
}
